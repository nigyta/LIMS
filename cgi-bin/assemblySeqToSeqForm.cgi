...
<form id="newAssemblySeqToSeq" name="newAssemblySeqToSeq" action="assemblySeqToSeq.cgi" enctype="multipart/form-data" method="post" target="hiddenFrame">
	...
	<table>
	<tr><td><b>Alignment Settings:</b></td><td style='text-align:left' colspan='2'><input type="checkbox" id="newAssemblyRedoAllSeqToSeqCheckbox" name="redoAllSeqToSeq" value="1"><label for="newAssemblyRedoAllSeqToSeqCheckbox">For All Sequences</label></td><td><input type="checkbox" id="newAssemblySeqToSeqSpeedyMode" name="speedyMode" value="1"><label for="newAssemblySeqToSeqSpeedyMode" title="This will skip 'Check End Match'">Speedy Mode</label><br><input type="checkbox" id="newAssemblySeqToSeqCheckGood" name="checkGood" value="1" checked="checked"><label for="newAssemblySeqToSeqCheckGood">Check End Match</label></td></tr>
	...
	<tr><td></td><td style='text-align:left'><input type="checkbox" id="newAssemblyMegablastCheckbox" name="megablast" value="megablast" checked="checked"><label for="newAssemblyMegablastCheckbox">Megablast</label></td></tr>
	</table>
</form>
<script>
