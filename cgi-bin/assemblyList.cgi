...
if ($assemblyId)
{
	...
	$assemblyList .= "<li><a href='download.cgi?assemblyId=$assemblyId&chr=all' target='hiddenFrame'><span class='ui-icon ui-icon-bullet'></span>Ctg PseudoMolecules</a></li>
						...
						<li><a><span class='ui-icon ui-icon-transfer-e-w'></span>Alignment</a>
							<ul style='z-index: 1000;white-space: nowrap;'>
								<li><a onclick='openDialog(\"genomeAlignmentForm.cgi?assemblyId=$assemblyId\")'><span class='ui-icon ui-icon-bullet'></span>New Alignment</a></li>
								<li><a onclick='openDialog(\"genomeAlignmentLoadForm.cgi?assemblyId=$assemblyId\")' title='BLAST Tabular Format'><span class='ui-icon ui-icon-bullet'></span>Load Alignment in Tabular</a></li>";
