...
if ($libraryId)
{
	...
	$button .= ($cloneList->rows > 0) ? "<li><a href='cloneList.cgi?libraryId=$libraryId' target='hiddenFrame'><span class='ui-icon ui-icon-bullet'></span>Download</a></li></ul></li>" : "<li class='ui-state-disabled'><a><span class='ui-icon ui-icon-bullet'></span>Download</a></li></ul></li>";
	$button .= ($tagList->rows > 0) ? "<li><a><span class='ui-icon ui-icon-tag'></span>WGP Tags</a><ul style='z-index: 1000;'><li><a href='tagList.cgi?libraryId=$libraryId' target='hiddenFrame'><span class='ui-icon ui-icon-bullet'></span>Download</a></li><li><a onclick='openDialog(\"tagNew.cgi?libraryId=$libraryId\")'><span class='ui-icon ui-icon-bullet'></span>Load New</a></li></ul></li>" : "<li><a onclick='openDialog(\"tagNew.cgi?libraryId=$libraryId\")'><span class='ui-icon ui-icon-tag'></span>Load WGP Tags</a></li>";
