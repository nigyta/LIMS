...
while (my @getSequences =  $getSequences->fetchrow_array())
{
	...
	$sequences .= "<tr><td style='text-align:center;'><input type='checkbox' id='seqList$getSequences[0]$$' name='seqId' value='$getSequences[0]'></td><td>$getSequences[2]</td><td>$getSequences[5]</td><td>$sequenceDetails->{'description'}</td></tr>";
}
